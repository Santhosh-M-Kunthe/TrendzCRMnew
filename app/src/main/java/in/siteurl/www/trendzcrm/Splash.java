    ...
    private void parseJSON(String response) {
        try {
            ...
            if (sucessORfailure.contains("false"))
            {
                ...
                intent.putExtra("response",responseWhole.getString("sid"));
                intent.putExtra("usrid",responseWhole.getJSONArray("List of units").getJSONObject(0).getString("customer_id"));
